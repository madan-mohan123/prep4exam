      ...
      return Scaffold(
        ...
        body: ListView(shrinkWrap: true, children: [
          ...
          Container(
              alignment: Alignment.center,
              margin: EdgeInsets.fromLTRB(15, 5, 15, 5),
              child: MyTimeForExam(int.parse(_timerforTimer), _examIdforTimer)),
          Divider(
            height: 3.0,
            color: Colors.grey,
          ),
                          ...
                          onPressed: () async {
                            ...
                            if (ind == lengthd) {
                              ...
                              if (widget.admin) {
                                ...
                                showAlertDialogs.showAlertDialog(context,
...
class _MyTextInputState extends State<MyTextInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(physics: NeverScrollableScrollPhysics(), shrinkWrap: true,
